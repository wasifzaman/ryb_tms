languages = \
{
	"english": {
		...
		"Notes": "Notes",
		"No student": "Teacher was not found!\nPlease try again!",
		"Con student": "Are you sure you would like\nto add this to the Database?",
		"Con S student": "Are you sure you would like\nto save this teacher's information to the Database?",
		"Ase student": "Teacher with this barcode exists in the database\nAdding this teacher will overwrite the existing student.\nOverwrite current student?",
		...
		"Overwrite Checkout": "Teacher checked-out today.\nOverwrite current check-out?",
		...
		"no_pw_set_pw": "Password must be reset.Please enter the old password\nfollowed by the new password",
