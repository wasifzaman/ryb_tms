languages = \
{
	"english": {
		...
		"Con student": "Are you sure you would like to add this to the Database?",
		"Con S student": "Are you sure you would like to save this teacher's information to the Database?",
		"Ase student": "Teacher with this barcode exists in the database Adding this teacher will overwrite the existing student. Overwrite current student?",
		"Teacher has been added to the database": "Teacher has been added to the database",
		"Cs student": "Check in the teacher?",
	...
	"chinese": {
		...
		"Con student": "你确定你想这位老师向数据库中添加?",
		"Ase student": "一个老师用相同的条码。如果想添加这个老师,你要覆盖旧的老师 ",
